...
puzzle_solution([[_|X_axis]|Tail]) :-
    ...
    distinct_constrain(Grid),
    transpose(Grid, Grid_T),
    distinct_constrain(Grid_T),
...
% ---------------------------------------------------------------------
distinct_constrain([]).
distinct_constrain([X|Xs]) :-
    all_distinct(X),
    distinct_constrain(Xs).
...
% --------------------------------------------------------------------
% key section of the program which could guess 
...
% ---------------------------------------------------------------------
% try all solutions which generated by guess_number
...
% -----------------------------------------------------------------------
% enumerate all solutions which satisfy the sum and multiplication rules
